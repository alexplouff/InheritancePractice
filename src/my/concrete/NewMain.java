...
//        Employee e5 = new SalaryPlusCommissionEmployee( "Cindy" , "Plouff" , "D322" , 70000 );
        ...
        Employee [] employee ={
        new HourlyEmployee("Alex" , "Plouff" , "E102" , 15 , 40),
        new HourlyEmployee( "Scott" , "Plouff" ,"R201" , 20 , 40 ),
        new SalariedEmployee( "Ashley" , "Plouff" , "F422" , 50000),
        new SalaryPlusCommissionEmployee("Jamie" , "Plouff" , "A233" , 65000),
        new SalaryPlusCommissionEmployee( "Cindy" , "Plouff" , "D322" , 70000 )
        };
